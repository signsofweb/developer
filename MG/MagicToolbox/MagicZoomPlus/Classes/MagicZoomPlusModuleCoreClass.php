...
class MagicZoomPlusModuleCoreClass
{
    ...
    public function getHeadersTemplate($jsPath = '', $cssPath = null)
    {
        ...
        $headers = [];
        $headers[] = '<!-- Magic Zoom Plus Magento 2 module version v1.5.20 [v1.6.64:v5.2.4] -->';
    ...
    public function loadDefaults()
    {
        $params = [
            ...
            "selectorTrigger"=>["id"=>"selectorTrigger","advanced"=>"1","group"=>"Multiple images","order"=>"10","default"=>"click","label"=>"Swap trigger","description"=>"Mouse event used to swtich between multiple images.","type"=>"array","subType"=>"radio","values"=>["click","hover"],"scope"=>"magiczoomplus","desktop-only"=>""],
