 ...
 *
 */
class Imaginato_Contacts_Block_Adminhtml_Customer_Service_Enquery_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('imaginatoEnqueryGrid');
    ...
    {
        $collection = Mage::getModel('imaginato_contacts/enqueries')->getCollection();
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn('enquery_type_id', 
            array(
                'header'=>$this->_getHelper()->__('Enquery type'),
                'sortable'=>false,
				'filter'    => false,
                'index'=>'enquery_type_id',
				'renderer' => 'imaginato_contacts/adminhtml_renderer_type_enquery',
            )
        );
		/**
