...
class Imaginato_TargetRule_Block_Adminhtml_Targetrule_Edit_Tab_Main
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $max_number = Mage::helper('enterprise_targetrule')->getMaxProductsListResult();
        $fieldset->addField('positions_limit', 'text', array(
            'name'  => 'positions_limit',
            'label' => Mage::helper('enterprise_targetrule')->__('Result Limit'),
            'note'  => Mage::helper('enterprise_targetrule')->__('Maximum number of products that can be matched by this Rule. Capped to '.$max_number.'.'),
        ));
