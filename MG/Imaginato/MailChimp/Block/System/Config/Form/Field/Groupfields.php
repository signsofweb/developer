<?php
class Imaginato_MailChimp_Block_System_Config_Form_Field_Groupfields extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    public function __construct()
    {
        ...
        $groupId = Mage::helper('imaginato_mailchimp')->getGroup($scopeArray[1], $scopeArray[0]);
        if(empty($groupId)){
            return;
        }
        try{
