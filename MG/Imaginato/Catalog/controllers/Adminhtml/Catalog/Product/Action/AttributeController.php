<?php
require_once Mage::getModuleDir('controllers', 'Mage_Adminhtml').DS.'Catalog/Product/Action/AttributeController.php';

class Imaginato_Catalog_Adminhtml_Catalog_Product_Action_AttributeController extends Mage_Adminhtml_Catalog_Product_Action_AttributeController
{
    /**
        ...
        try {
            if ($attributesData) {
                ...
                if(isset($attributesData['status'])){
                    ...
                    $simpleIds = $importModel->getSimples($this->_getHelper()->getProductIds(),'id');
                    if(!empty($simpleIds) && $attributesData['status'] == Mage_Catalog_Model_Product_Status::STATUS_ENABLED){
            ...
            Mage::helper('skusrule')->bathUpdate($this->_getHelper()->getProductIds(), $this->_getHelper()->getSelectedStoreId());
